...
result2=re.fullmatch(r"\d{10}","6189635904")

print(result2)


print(re.findall(r"\d+","price 100 and 200 and 500"))

for n in re.finditer(r"\d+","A1 b500, B44,C55"):
    print(n.group(),n.start(),n.end())

print(re.search(r"\d+","age is 48"))
print(re.search(r"^a.*c$","akashc"))
m=re.search(r"\w+(?=@)","akash@2002.com")
print(m.group())



print(re.search("AKASH","AKASH",re.I))


text5="three\nsix\nseven"
print(re.findall(r"^t\w+",text5,re.M))
